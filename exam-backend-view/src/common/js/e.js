webpackJsonp([1], [function(e, exports, t) {
    ...
    function(e, exports) { !
        function() {
            ...
            location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function() {
                ...
                angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "monitorService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService",
                    function(e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h, M, v, y, b, C, w) {
                        ...
                        window.MMCgi.isLogin && (N(), h.browser.chrome && !MMDEV && (window.onbeforeunload = function(e) {
                            ...
                            e && (e.returnValue = "鍏抽棴娴忚鍣ㄨ亰澶╁唴瀹瑰皢浼氫涪澶便€�"),
                                "鍏抽棴娴忚鍣ㄨ亰澶╁唴瀹瑰皢浼氫涪澶便€�"
                        })),
                            t.$on("newLoginPage",
                                function(e, t) {
                                    f.setSkey(t.SKey),
    ...
    function(e, exports) { !
        function() {
            "use strict";
            angular.module("Controllers").controller("loginController", ["$scope", "loginFactory", "utilFactory", "reportService", "monitorService",
                function(e, t, a, n, i) {
                    function o(c) {
                        switch (c.code) {
                            case 200:
                            ...
                            case 201:
                                e.isScan = !0,
                                    ...
                                    t.checkLogin(e.uuid).then(o,
                                        function(t) { ! t && window.checkLoginPromise && (e.isBrokenNetwork = !0)
                                        });
                                break;
                            case 408:
                                t.checkLogin(e.uuid).then(o,
        ...
        function() {
            ...
            angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory",
                function(e, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h, M, v, y) {
                    ...
                    function C(t) {
                        for (var a = e.imagesMessagesList,
                                 n = 0; n < a.length; n++) if (a[n].msg.MsgId == t.MsgId) {
                            a.splice(n, 1);
                            break
                        }
                    }
                    ...
                    e.delState = !1,
                        ...
                        e.$on("message:add:success",
                            function(t, a) {
                                a.MMPeerUserName !== c.getCurrentUserName() && (a._h || e.heightCalc(a,
                                    function(e) {
                                        a._h = e
                                    }))
                            }),
                        ...
                        e.$on("root:msgSend:success",
                            function(t, a) {
                                if (a.MsgType == f.MSGTYPE_IMAGE && e.imageInit(a), a.ToUserName == e.currentUser) for (var n = 0,
                                                                                                                            i = e.chatContent.length; n < i; ++n) {
                    ...
                    e.$on("onScroll",
                        ...
                        e.imageInit = function(t, a) {
                            for (var n, i, o, r = e.imagesMessagesList,
                                     c = !1,
                                     i = e.getMsgImg(t.MsgId), s = 0; s < r.length; s++) if (n = r[s], n.msg === t) {
                                c = !0,
                                    n.url = i,
                                    o = s;
                                break
                                    ...
                                    function(t) {
                                        a(function(a) {
                                            ...
                                            t.addCharRoomMember = function() {
                                                var e = {};
                                                angular.forEach(t.currentContact.MemberList,
                                                    function(t) {
                                                        e[t.UserName] = t
                                                    }),
                                    ...
                                    setTimeout(function() {
                                            ...
                                            if (n.MsgType == f.MSGTYPE_EMOTICON || n.MsgType == f.MSGTYPE_IMAGE || n.MsgType == f.MSGTYPE_VIDEO) {
                                                ...
                                                var c = a.find(".content .msg-img"),
                                                    s = c.height(),
                                                    l = {};
                                                if (n.ImgHeight) n.MsgType == f.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * c.width() / n.ImgWidth + "px", l.widht = c.width() + "px") : (l.height = n.ImgHeight, l.width = n.ImgWidth),
                                                    n.MMImgStyle = l,
                                                    t.$digest(),
                                                    i(a.height()),
                                                    t.$destroy(),
                                                    a.remove();
                                                else if (s > 40 || 1 == c[0].complete && 0 !== c[0].naturalWidth && s > 0) i(a.height()),
                                                    t.$destroy(),
                                                    a.remove();
                                                else {
                                                    if (n.MMPreviewSrc) return c[0].onload = o,
                                                        c[0].onerror = r,
    ...
    function(e, exports, t) { !
        function() {
            "use strict";
            angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", "monitorService",
                function(e, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h) {
                    ...
                    function w(e, t) {
                        var a, n;
                        if (t || y(), window.getSelection) { ! t && U ? (a = P, n = U) : (a = window.getSelection(), n = a.getRangeAt(0)),
                            n.deleteContents();
                            var i;
                        ...
                        } else n = t || !U ? document.selection.createRange() : U,
                                ...
                                try {
                                    K = e.create({
                                        ...
                                        function(e) {
                                            ...
                                            if (h.report(h.UPLOAD_COUNT, 1), 0 == e.size) return K.skipFile(e),
                                                alert(_("61e885c")),
                                                !1;
                                            if (e._data = e._data || {},
                                            ...
                                            return K.md5File(e).then(function(t) {
                                                function a(e, t, a) {
                                                    ...
                                                    e._uploadParams = s,
                                                        ...
                                                        t ? (K.trigger("fileQueued", e), K.trigger("uploadSuccess", e, a), K.skipFile(e)) : (e._checked = !0, K.addFiles(e))
                                                }
                                                var s = Date.now() - o,
                    ...
                    a.sendClick = function(e) {
                        var t = l.setSendFileUsername(l.getCurrentUserName());
                        if (!t) return (!Y || e.timeStamp - Y > 30) && (Y = e.timeStamp, alert(_("599d8df"))),
                            e.preventDefault(),
                            e.stopPropagation(),
                            !1
                    },
                        a.screenShot = function() {
                            ...
                            d.isSupport() ? d.capture({
                                ok: function() {
                                    ...
                                    e = T(t),
                                        d.upload(JSON.stringify(t),
                                            function(t) { ! t.BaseResponse || t.BaseResponse && 0 != t.BaseResponse.Ret ? (alert(_("76a7e04")), e.close()) : e.update(r.API_webwxpreview + "?fun=preview&mediaid=" + t.MediaId, t.MediaId)
                                            })
                                }
                                    ...
                                    this.MMSendMsg = l.createMessage({
                                        ...
                                        function(t) {
                                            t.MMSendMsg.MMThumbSrc = "",
                                                K.makeThumb(t,
                                                    function(a, n) { ! a && n || p.report(p.ReportType.uploaderError, {
                                                        text: "鍒涘缓缂╃暐鍥惧け璐�",
                    ...
                    window.WebUploader ? k() : e.$on("root:pageInit:success",
                        function() {
                            k()
                        })
                }])
    ...
    function(e, exports) { !
        function() {
            "use strict";
            angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", "monitorService",
        ...
        function() {
            ...
            angular.module("Controllers").controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory",
                function(e, t, a, n, i, o, r, c, s, l, d, f) {
                    ...
                    function m(a) {
                        t.contextMenuList = [];
                        var n = r.getContact(a); (n.isRoomContact() || n.isContact()) && (n.isTop() ? t.contextMenuList.push({
                            content: _("84e4fac"),
                            callback: function() {
                                r.setTopContact(a, !1)
                            }
                                    ...
                                    controller: ["$scope",
                                        function(e, t) {
                                            e.keypress = function(e) {
                                                var t = $(".chatroom_topic .chatroom_name").text().length; [8, 37, 39, 46].indexOf(e.keyCode) === -1 && t > 17 && e.preventDefault()
                                            },
    ...
    function(e, exports) { !
        function() {
            "use strict";
            angular.module("Controllers").controller("systemMenuController", ["$rootScope", "$scope", "$timeout", "ngDialog", "loginFactory", "confFactory", "accountFactory", "utilFactory", "monitorService", "oplogFactory",
                function(e, t, a, n, i, o, r, c, s, l) {
                    t.createChatroom = function() {
                        n.open({
                            templateUrl: "createChatroom.html",
                            controller: "createChatroomController",
                            ...
                            return window.synccheck && (window.synccheck.selector = 0),
                                $.ajax({
                                    ...
                                    window.synccheck && "0" == window.synccheck.retcode ? "0" != window.synccheck.selector ? c.sync().then(function(t) {
                                        ...
                                        function(e) {}) : e.reject(window.synccheck && window.synccheck.selector) : !window.synccheck || "1101" != window.synccheck.retcode && "1102" != window.synccheck.retcode ? window.synccheck && "1100" == window.synccheck.retcode ? i.loginout(0) : (e.reject("syncCheck net error"), r.report(r.ReportType.netError, {
                        ...
                        service = {
                                        ...
                                        function(a, n) {
                                            ...
                                            if (o && !o.isBrandContact() && !o.isShieldUser()) {
                                                if (a == _currentUserName) {
                                                    var c = e.getUnreadMsgsCount(a); (!o.unreadCount || o.unreadCount < c) && (o.unreadCount = e.getUnreadMsgsCount(a)),
                            ...
                            _commonMsgProcess: function(e) {
                                ...
                                e.Content = e.Content || "",
                                    ...
                                    utilFactory.isRoomContact(e.MMPeerUserName) ? (e.MMIsChatRoom = !0, i = e.Content.replace(/^(@[a-zA-Z0-9]+|[a-zA-Z0-9_-]+):<br\/>/,
                                        function(e, t) {
                                            return o = t,
                                                ""
                                        }), o && o != accountFactory.getUserName() && (t = contactFactory.getContact(o, e.MMPeerUserName), t && (r = t.getDisplayName(e.MMPeerUserName), r && (e.MMDigest = r + ":")))) : (e.MMIsChatRoom = !1, i = e.Content),
                            ...
                            _systemMsgProcess: function(e) {
                                ...
                                if (t) for (var a, n, i = 0,
                                                o = t.length; i < o; ++i) a = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(t[i]),
                    ...
                    var u, m = window._contacts = {},
                        ...
                        G = {
                            ...
                            isInChatroom: function() {
                                var e = this;
                                return 0 == this.MemberList.length && 0 != this.ContactFlag || (e.MMInChatroom === !1 || e.MMInChatroom === !0 ? e.MMInChatroom: (angular.forEach(this.MemberList,
                                    function(t) {
                            ...
                            getDisplayName: function(e) {
                                var t = this,
                                    a = "";
                                if (c.isRoomContact(t.UserName)) if (a = t.RemarkName || t.NickName, !a && t.MemberList) for (var n = 0,
                                                                                                                                  i = t.MemberList.length; n < i && n < 10; ++n) {
                                    a.length > 0 && (a += ", ");
                            ...
                            chatroomCanSearch: function(e) {
                                if (this.isRoomContact()) {
                                    ...
                                    for (var t = 0,
                                             a = this.MemberList.length; t < a; t++) {
                            ...
                            canSearch: function(e, t) {
                                ...
                                s >= 0 || l >= 0 || (s = i.toUpperCase().indexOf(e), l = o.toUpperCase().indexOf(e), s >= 0 || l >= 0 || (r.toUpperCase().indexOf(e) >= 0 || c.toUpperCase().indexOf(e) >= 0))
                            },
                            update: function(e) {
                        ...
                        I = {
                            ...
                            inContactsWithErrorToGetList: function(e) {
                                for (var t = 0,
                                         a = w.length; t < a; t++) if (w[t].UserName == e.UserName) return t;
                                return - 1
                            },
                            inContactsToGetList: function(e) {
                                for (var t = 0,
                                         a = b.length; t < a; t++) if (b[t].UserName == e.UserName) return t;
                                return - 1
                            },
                            inContactsGettingList: function(e) {
                                for (var t = 0,
                                         a = C.length; t < a; t++) if (C[t].UserName == e.UserName) return t;
                                return - 1
                            },
                            ...
                            addBatchgetContact: function(e, t, i) {
                                ...
                                function s(e) {
                                    ...
                                    C = [],
                                        N++,
                                        f.reject(e),
                                        1 == t.length ? S[t[0].UserName] = 1 : angular.forEach(t,
                                            function(e) {
                            ...
                            addBatchgetChatroomMembersContact: function(e) {
                                var t = this,
                                    a = t.getContact(e);
                                a && a.isRoomContact() && !a.MMBatchgetMember && a.MemberList.length > 0 && (a.MMBatchgetMember = !0, angular.forEach(a.MemberList,
                                    function(e) {
                            ...
                            batchGetContact: function(e) {
                                var n = a.defer(),
                                    r = 1;
                                return w.length ? (r = w.length < 6 || N > 2 ? 1 : w.length < 40 ? 5 : 10, C = w.splice(0, r)) : C = b.splice(0, 50),
                                    t({
                                        method: "POST",
                            ...
                            pickContacts: function(e, t, a) {
                                for (var n, i, o, r = [], c = this, s = t.all || {},
                                    ...
                                    case "friend":
                                        if (i = c.getAllFriendContact(o), i.length > 0) {
                                            ...
                                            var d = "";
                                            o.showFriendHeader || o.noHeader || angular.forEach(i,
                                                function(e, t) {
                                                    if (e.MMOrderSymbol) {
    ...
    function(e, exports, t) { !
        function() {
            ...
            angular.module("Services").factory("utilFactory", ["$q", "$rootScope", "confFactory",
                function(e, a, n) {
                    function i(e, t, a, n) {
                        var i; (i = d[e]) ? (i.intervalSum += a, n && n <= i.intervalSum && (setTimeout(t, 0), d[e].intervalSum = 0), clearTimeout(i.timer), i.timer = setTimeout(function() {
                                delete d[e],
                                    setTimeout(t, 0)
                            },
                ...
                function(e, t, a, n) {
                    var i = {
                        ...
                        emoticonFormat: function(e) {
                            var t = this;
                            return 0 == e.length ? "": (e = e.replace(new RegExp("(\\[.+?\\])(?!" + a.MM_EMOTICON_WEB + ")", "g"),
                                function(e, a) {
                                    return t.getEmoticonByText(a) || e
                                }).replace(new RegExp("&lt;(.+?)&gt;(?!" + a.MM_EMOTICON_WEB + ")", "g"),
                                function(e, a) {
                                    return t.getEmoticonByText("<" + a + ">") || e
                ...
                function(e, t) {
                    ...
                    function r(a, i) {
                        ...
                        r.StopUpload(),
                            r.ClearHeaders(),
                            r.ClearFormItems(),
                        r && (r.URL = (MMDEV ? "http://wx.qq.com": "http://" + location.hostname) + e.API_webwxpreview + "?fun=upload", r.AddHeader("Cookie", document.cookie), r.AddFormItem("msgimgrequest", 0, 0, a), r.AddFormItem("filename", 1, 4, o()), r.OnEvent = function(e, a) {
                            switch (a) {
                                case 2:
                                    break;
                                case 3:
                ...
                function(e) {
                    ...
                    function c(e, n) {
                        ...
                        return g && r() && angular.isString(e) && n && (angular.isString(n.icon) || angular.isObject(n.icon)) && i() === l && (o = t(e, n)),
                            c = a(o),
                            h.push(c),
                        M.autoClose && o && !o.ieVerification && o.addEventListener && o.addEventListener("show",
                            function() {
                                var e = c;
                                setTimeout(function() {
                                        e.close()
    ...
    function(e, exports, t) { !
        function() {
            "use strict";
            angular.module("Services").factory("monitorService", ["$http", "$rootScope", "confFactory", "accountFactory",
                function(e, a, n, i) {
                    function o(e, t, a) {
                        a || (a = 0),
                            r(c.ID, e, t, a)
                    ...
                    function i(e, t, a) {
                        ...
                        void 0 === r && (r = (0, s.
                            default)(function() {
                                var a = l.get(i);
                                if (void 0 !== a) {
                                    var n = "https://support.weixin.qq.com/cgi-bin/mmsupport-bin/reportforweb?rid=" + e + "&rkey=" + t + "&rvalue=" + a; (new Image).src = n,
                                        l.clear(i),
                                        d.clear(i)
                                }
                            },
                        ...
                        function n(e, t) {
                            var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                                ...
                                s = function() {
                                    ...
                                    i = this,
                                        o = arguments,
                                        l <= 0 || l > t ? (n && (clearTimeout(n), n = null), r = s, e.apply(i, o), n || (i = o = null)) : n || a.trailing === !1 || (n = setTimeout(c, l))
                                };
                            return s
                        }
                        Object.defineProperty(t, "__esModule", {
                ...
                function(e, t, a) {
                    ...
                    for (var i, o = function(e) {
                            ...
                            return n && i.push(n),
                             ...
                             r = ["post", "get", "jsonp"], c = 0; c < r.length; c++) i = r[c],
                        o[i] = function(t) {
                            return function(a) {
                                var i, o, r = [a];
                                ...
                                var c;
                                i && r.push(i),
                                o && (c = "undefined" != typeof o.MMRetry, r.push(o));
                                var s;
                                return s = c ? n({
                                    args: r,
                                    method: t,
                        ...
                        var p = o.find("body"),
                            h = {
                                ...
                                performClosePop: function(e, t) {
                                    var a = e.attr("id"),
                                        r = e.scope();
                                    r && !r.closing && (r.closing = !0, e.unbind("click"), 1 === n && p.unbind("keydown"), d.$broadcast("root:mmpop:closing", a), g.leave(e,
                                        function() {
                                    ...
                                    function(require) {
                                        ...
                                        jQuery(o).jPlayer({
                                            ready: function() {
                                                ...
                                                r.loop !== e && u && (jQuery(this).jPlayer("play"), s())
                                            },
                                            click: function() {
                    ...
                    a.provider("ngDialog",
                        function() {
                            ...
                            this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller",
                                function(d, f, u, m, g, p, h, M, v) {
                                    var y = d.find("body");
                                    s && p.$on("$locationChangeSuccess",
                                        function() {
                                            y = d.find("body")
                                        });
                                    var b = {
                                            ...
                                            open: function(r) {
                                                ...
                                                return m.when(s(w.template || w.templateUrl)).then(function(t) {
                                                    ...
                                                    if (E.closeThisDialog = function(e) {
                                                            ...
                                                            }), w.closeByEscape && y.bind("keydown", b.onDocumentKeydown), w.closeByNavigation && p.$on("$locationChangeSuccess",
                                                            function() {
                                                                b.closeDialog(T)
                                                            }), a = function(e) {
                                                            var t = !!w.closeByDocument && n(e.target).hasClass("ngdialog-overlay"),
                                                                a = n(e.target).hasClass("ngdialog-close"); (t || a) && C.close(T.attr("id"), a ? "$closeButton": "$document")
                                                        },
        ...
        angular.module("Directives").directive("mmRepeat", ["$document", "$compile", "$rootScope",
            function(e, t, a) {
                ...
                function o(e, t, a, o) {
                    ...
                    return f > 0 ? (d = n(e, 0, 0, f, o), r = d.index, f = d.total) : (r = 0, f = 0),
                        c = n(e, r, f, u, o).index,
                    ...
                    link: function(e, a, n) {
                        ...
                        e.bufferHeight || (e.bufferHeight = 100),
                            ...
                            e.$on("onScroll",
                                function(t, a) {
                                    return o = a.y,
                                        e.heightCalc && 2 === e.heightCalc.length && !d(i) ? void l(i, e.heightCalc,
                                            function() {
                                    ...
                                    if (c) {
                                        switch (e.keyCode) {
                                            case a.KEYCODE_ARROW_UP:
                                                do c = c._index - 1 < 0 ? m: d[c._index - 1];
                                                while (!n(c));
                                                c == m && (i = !0);
                                                break;
                                            case a.KEYCODE_ARROW_DOWN:
                                                do c = c._index + 1 >= d.length ? m: d[c._index + 1];
                                                while (!n(c));
                                                break;
                                            default:
                                                return
                    ...
                    link: function(t, a, n) {
                        function r(e) {
                            ...
                            if (f.canDo("navKeydown")) {
                                if (t.currentUserName) a = s(r, t.currentUserName),
                                    n = a,
                                    d.wait(function() {
            ...
            function(e, t, a, n, i, o, r, c, s, l, d, f, u) {
                ...
                return {
                    ...
                    link: function(t, a, n) {
                        ...
                        function s(e) { (!t.current || e) && t.contactList.length > 0 && t.keyword && r("header" == t.contactList[0].type ? t.contactList[1] : t.contactList[0])
                        }
                        var u;
                        t.$watch(function() {
                                    ...
                                    g = e(function() {
                                            if (t.keyword) {
                                                ...
                                                t.contactList = c.pickContacts(h.types, a, !0).result,
                                                    s(!0)
                                            } else t.contactList = o(c.pickContacts(h.types, h.opt, !0).result, M),
                                                s(!0)
                                        },
                                        200)
                            },
    ...
    function(e, exports) {
        angular.module("Directives").directive("mmError", ["$parse",
            function(e) {
                return {
                    restrict: "A",
    ...
    function(e, exports, t) { !
        function(e, a, n) {
            "use strict";
            a.module("ngClipboard", []).provider("ngClip",
                function() {
                    var e = this;
                ...
                function(n, i) {
                    ...
                    e.ZeroClipboard ? o() : n.$on("root:pageInit:success",
                        function() {
                            o()
                        })
                    ...
                    return {
                        ...
                        link: function(e, n, i) {
                            t.e(4,
                                function(require) {
                                    var o = t(340);
                                    if (o.isFlashUnusable()) return void n.bind("click",
                                        function(t) {
    ...
    function(e, exports) { !
        function() {
            ...
            angular.module("Filters").filter("HTMLEnCode",
                function(e, t, a) {}).filter("HTMLDeCode",
                function() {
                    return function(e, t, a) {
